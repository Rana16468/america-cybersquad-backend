...
router.get("/find_by_fees_management",branchAdminAuth(UserRole.BRANCH_ADMIN), FeesManagementController.findByFeesManagement );
...
router.get("/find_by_all_payable_fees", 
      branchAdminAuth(UserRole.BRANCH_ADMIN, UserRole.INSTITUTIONAL_OWNER), 
      FeesManagementController.findByAllPayableFees);
...
router.get("/find_my_all_fess", branchAdminAuth(UserRole.STUDENT),FeesManagementController.findBySpecificStudentFeesList)
